		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Work Order",
									"targetURL": "#megworkorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"megworkorder-display": {
								"semanticObject": "megworkorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=meg.workorder",
									"url": sap.ui.require.toUrl("meg/workorder")
								}
							}
						}
					}
